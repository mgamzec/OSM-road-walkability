...
DROP FUNCTION IF EXISTS edge_get_points_sum;
CREATE OR REPLACE FUNCTION edge_get_points_sum(table_point TEXT, snap_distance integer, weight_attr TEXT DEFAULT '')
RETURNS TABLE(id int, points_sum integer)
 LANGUAGE plpgsql
AS $function$
DECLARE
